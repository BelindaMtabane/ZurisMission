...
/// <summary>
/// Rolling log spanning two or three lanes. Jump over it or switch lanes.
/// </summary>
public class Level2RollingLog : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (phase == Phase.Wait)
        {
            ...
            {
                phase = Phase.Roll;
                Level2FeedbackUI.Show("ROLLING LOG — JUMP!", new Color(0.72f, 0.48f, 0.22f), 1.2f);
            }
            return;
        }
    ...
    void TryHandleHit(Collider other)
    {
        ...
        if (IsJumpingOver(controller, other))
        {
            if (!jumpPenaltyApplied)
            {
                ...
                hud?.BreakMaterials(Level2Config.LogJumpMaterialLoss);
            }
            return;
        }
        ...
        hud?.ChangeHealth(-Level2Config.LogHealthDamage, "A rolling log hit you!");
    }
